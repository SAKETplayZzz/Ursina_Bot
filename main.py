...
@slash.slash(name="entity", description="Show you how an help on how to post code",guild_ids=guild_ids)
...
@slash.slash(name="mcinfgen", description="Show you how an help on how to post code",guild_ids=guild_ids)
...
@slash.slash(name="model", description="What file type can I use as models",guild_ids=guild_ids)
async def _mod(ctx):
...
@slash.slash(name="sound", description="How can play an audio file ?",guild_ids=guild_ids)
async def _gif(ctx):
